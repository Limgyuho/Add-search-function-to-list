...
import creatboard8.dto.Article;
import creatboard8.util.Util;
	...
	public void run() {
		...
		while (true) {
			...
			if (cmd.equals("article write")) {
				...
				List<Article> foundInArticles = articles;
				
				System.out.println("번호	|	제목	|	조회");
				for (int i = foundInArticles.size() - 1; i >= 0; i--) {
					// 게시물이 저장되고 보여줄때 1번 부터 보여주게 하기 위함
					Article article = foundInArticles.get(i);
